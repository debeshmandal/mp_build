...
Then get the URL (e.g. something like github.com/myusername/mp_build) and run the following commands

```
git remote add origin https://${GH}@github.com/myusername/mp_build
